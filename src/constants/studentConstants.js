...
export const GET_MORE_STUDENT_REQUEST = 'GET_MORE_STUDENT_REQUEST'
export const GET_MORE_STUDENT_SUCCESS = 'GET_MORE_STUDENT_SUCCESS'
export const GET_MORE_STUDENT_FAIL = 'GET_MORE_STUDENT_FAIL'